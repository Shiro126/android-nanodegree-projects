...
public class FamilyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locations.add(new Location(R.string.park,R.string.park_loc,R.string.park_desc,R.drawable.park));
        LocationAdapter locationAdapter = new LocationAdapter(getActivity(), locations,R.color.family);
